...
function Brand() {
  return (
    <>
      {/* first */}
      <div className="mt-[64px] md:mt-0 bg-[url('https://pn-paul.netlify.app/image/brands.jpg')] w-100">
        <h1 className="py-[100px] md:py-[250px] text-2xl md:text-6xl text-white text-center font-[pargue]">
          BRAND
        </h1>
      </div>
      {/* second */}
      <div className="px-3 md:flex md:justify-evenly my-10">
        <img
          className="md:w-[25%] hover:scale-105 duration-200 ease-in-out mb-5"
      ...
      <div className="px-3 md:flex md:justify-evenly my-10">
        ...
        />
        <img
          className="w-full md:w-[25%] hover:scale-105 duration-200 ease-in-out mb-5"
